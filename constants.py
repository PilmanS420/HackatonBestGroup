...
# Order coordinates
ORDER_LOCATION = (1452, 483)
ORDER_LAFFA_SIZE = (1897 - ORDER_LOCATION[0], 607 - ORDER_LOCATION[1])  # Basically the size of the entire order screen
ORDER_ROW_OFFSET = 62
ORDER_INGREDIENT_WIDTH = ORDER_LOCATION[0] + int(ORDER_LAFFA_SIZE[0] * 2 / 3)
ORDER_INGREDIENT_SIZE = (1897 - ORDER_INGREDIENT_WIDTH, 607 - ORDER_LOCATION[1])
